---
name: deploy-lambda
description: Deploy Lambdas using the guaranteed deploy scripts only. Never deploy via IAC (CDK). Requires AWS SSO login first. Use when deploying any Lambda repo.
---
